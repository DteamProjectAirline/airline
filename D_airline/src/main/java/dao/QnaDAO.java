...
public class QnaDAO {
	//QnA생성
	public static int qaInsert(String qnaId, String title, String content, String empId) throws Exception{
		int QaRow = 0;
		...
		String sql = "INSERT INTO q&a(qna_id, title, content, create_date, update_date)VALUES(?,?,?,now(),now())";
