...
<body>
	...
	<form action="/D_airline/emp/cityManageAddAction.jsp" method="post">
		<div>
			...
			<label for="nation">국가</label> <select name="countryId" id="nation">
				<%
				//목록에 뿌려줄 모든 국가리시트 출력	
				...
				%>
			</select> <input type="text" name="airport" placeholder="airport" required>
	...
	<form action="/D_airline/emp/cityManageModifyAction.jsp" method="post">
		<div>
			...
			<label for="city">변경도시이름</label> <input type="text" id="city"
				name="keyCityName" list="keyCityName" required>
