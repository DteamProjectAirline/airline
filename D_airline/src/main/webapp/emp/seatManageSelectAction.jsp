...
if (selectSeatNo != null && !(selectSeatNo.isEmpty()) && selectSelectedFlightInfo != null && !(selectSelectedFlightInfo.isEmpty())) {
	System.out.println("항공편-좌석 조회에 성공하였습니다.");
	msg = URLEncoder.encode("항공편-좌석 조회에 성공하였습니다.", "UTF-8");
	checkFlight = "1";
	response.sendRedirect("/D_airline/emp/seatManage.jsp?msg=" + msg + "&checkFlight="+checkFlight+"&flightId="+flightId);
